...
$(document).ready(function () {
    ...
    $('#exampleFormControlSelect1').on('change', function () {
        if ($(this).find("option:selected").attr("id") == "umElFahem") {
            ...
            $('#coordinatorImg1').attr('data-content', 'רכז: טובה יערי');
            $('#locationImg1').attr('data-content', 'רמז 80, רחובות');
            $('#phoneImg1').attr('data-content', 'טלפון: 08-9314806');
            //$('#emailImg').show();
            $('#emailImg1').show();
            $('#emailImg1').attr('data-content', '<a href="mailto:info@haplatforma.org.il" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#facebookImg1').attr('data-content', '<a href="https://www.facebook.com/HaplatformaRehovot/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
    ...
    $('#exampleFormControlSelect2').on('change', function () {
        if ($(this).find("option:selected").attr("id") == "umElFahemM") {
            ...
            $('#coordinatorImgM').attr('data-content', 'רכז: טובה יערי');
            $('#locationImgM').attr('data-content', 'רמז 80, רחובות');
            $('#phoneImgM').attr('data-content', 'טלפון: 08-9314806');
            //$('#emailImg').show();
            $('#emailImgM').show();
            $('#emailImgM').attr('data-content', '<a href="mailto:info@haplatforma.org.il" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#facebookImgM').attr('data-content', '<a href="https://www.facebook.com/HaplatformaRehovot/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
    ...
    $('#exampleFormControlSelect3').on('change', function () {
        if ($(this).find("option:selected").attr("id") == "umElFahemM2") {
            ...
            $('#locationImgM2').attr('data-content', 'יבניאלי 4, ראשון לצעון');
            ...
            $('#coordinatorImgM2').attr('data-content', 'רכז: טובה יערי');
            $('#locationImgM2').attr('data-content', 'רמז 80, רחובות');
            $('#phoneImgM2').attr('data-content', 'טלפון: 08-9314806');
            //$('#emailImg').show();
            $('#emailImgM2').show();
            $('#emailImgM2').attr('data-content', '<a href="mailto:info@haplatforma.org.il" class="outerLinks" >merkazrishon@gmail.com</a>');
            $('#facebookImgM2').attr('data-content', '<a href="https://www.facebook.com/HaplatformaRehovot/" class="outerLinks" target=_blank>לעמוד הפייסבוק</a>');
        }
